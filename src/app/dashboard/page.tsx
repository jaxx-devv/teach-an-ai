...
import { getRecentConversationsFor, renameTopicFor, deleteConversationFor, type Identity } from "@/lib/identity";
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if (!identity) return;
    (async () => {
      setConversations(await getRecentConversationsFor(identity, 3));
